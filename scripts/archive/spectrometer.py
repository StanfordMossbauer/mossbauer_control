...
class MossbauerSpectrometer:
    def __init__(self):
        ...
        self.skim_lower = 500  #@7-9"
        self.skim_upper = 850  #@7-9"
        self.skim_lower = 650  #@13"
        self.skim_upper = 900  #@13"
            ...
            for frequency in frequencies:
                try:
                    ...
                    with open("logfile.txt", "a") as logfile:
                        logfile.write("{} - caen reset, skipped value for frequency{:.2f}".format(time.strftime("%Y-%m-%d %H:%M:%S"), frequency))
